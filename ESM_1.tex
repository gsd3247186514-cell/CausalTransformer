...
\noindent\textbf{Contents.} This document contains supplementary methods (SM1--SM3), supplementary tables (S1--S7), supplementary figures (ESM Figs~1--3), and extended supplementary notes (SN1--SN23) referenced in the main text.
...
% ── Table S6: Method comparison ──
\begin{table}[htbp]
\centering
\caption{\textbf{Comparison of causal discovery methods at $d=200$ ($n=1000$, 10 seeds).} ``DAG'' = enforces acyclicity constraint; ``Real data'' = tested on TCGA; ``---'' = inapplicable.}
...
\midrule
NOTEARS & 0.0$\pm$0 & $\checkmark$ & No & 0 \\
The cluster-gating method & 0.0$\pm$0 & $\checkmark$ & Yes & 0 \\
...
% ── Table S7: Acyclicity convergence ──
\begin{table}[htbp]
\centering
...
\caption{\textbf{ESM Figure 2.} TCGA validation. (a) Per-cancer edge counts comparing CT vs.~NOTEARS at $d=200$. (b) Cluster-averaged coherence analysis across 10 cancer types.}
\label{fig:esm_tcga}
\end{figure}
